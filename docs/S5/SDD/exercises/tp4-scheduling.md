---
title: "TP4 - Emploi du Temps (Time Scheduling)"
sidebar_position: 4
---

# TP4 - Emploi du Temps (Time Scheduling)

> Following teacher instructions from: `S5/SDD/data/moodle/tp/tp4_scheduling/README.md`
