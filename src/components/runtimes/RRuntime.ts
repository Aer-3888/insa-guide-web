...
export class RRuntime extends BaseRuntime {
  ...
  /**
   * Override base execute to preserve images from R plots and
   * apply the longer R-specific timeout.
   */
  async execute(
    code: string,
    options?: ExecutionOptions,
  ): Promise<ExecutionResult> {
    const timeout = options?.timeout ?? R_TIMEOUT;
